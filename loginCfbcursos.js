class Login {
    ...
    static endPoint = "https://8d9dda2b-3f72-4f88-bf3a-b695164e40cb-00-2ropfdlhtpzh6.kirk.replit.dev/"
    static login = (callback_ok,callback_naook, config=null) => {
        ...
        imgLogo.setAttribute('src',this.img)
    ...
    static verificaLogin=()=>{
        ...
        const endPoint = `https://8d9dda2b-3f72-4f88-bf3a-b695164e40cb-00-2ropfdlhtpzh6.kirk.replit.dev/?matricula=${mat}&senha=${pas}`
        fetch(endPoint)
        .then(res=>res.json())
        .then(res=>{
            if(res){
